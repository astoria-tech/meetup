...
export const colors = {
        ...
        'link-hover': baseColors.link.light,
        'link-active': baseColors.link.light,
        'link-focus': baseColors.link.light,
        'link-visited': baseColors.link.dark,
        'link-disabled': baseColors.link.dark,
